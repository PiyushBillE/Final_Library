...
app.delete("/make-server-374bb1bc/student/:userId", async (c) => {
  try {
    ...
    // Delete student photo from storage if exists
    if (studentData.photoUrl) {
      try {
        // Extract filename from URL
        const urlParts = studentData.photoUrl.split('/');
    ...
    // Delete all related keys from KV store
    ...
    console.log(`Successfully deleted student ${userId} and all associated data`);
    return c.json({ success: true, message: 'Student data completely removed' });
